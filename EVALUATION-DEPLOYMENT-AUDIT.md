...
| `config/source-pod-credentials.local.json` | historical+live source-Pod credentials | ignored local configuration, or `HEIMDALL_SOURCE_POD_CREDENTIALS_FILE`; the normal live evaluation path does not use it |
