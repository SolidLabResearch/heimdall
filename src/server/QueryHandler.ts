...
export class QueryHandler {
     ...
     * @memberof QueryHandler
     */
    public static async handle_ws_query(query: string, width: number, query_registry: QueryRegistry, logger: any, websocket_connections: any, query_type: string, event_emitter: any, client_id?: string): Promise<void> {
